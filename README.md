# 👋 Привет, я Tahir Safarov

Python-разработчик, интересуюсь бэкендом и автоматизацией.

## 🛠️ Технологии
- Python, FastAPI, Django
- PostgreSQL, Docker, Pytest, Redis, RabbitMQ
-  Git
...
- **[python-backend-taxi-api](https://github.com/f0otstyle/python-backend-taxi-api)** - Актуальный REST API сервиса заказа такси на FastAPI.
   ...
   - Включает: Docker Compose (PostgreSQL + Redis), CI/CD на GitHub Actions и строгую типизацию.
